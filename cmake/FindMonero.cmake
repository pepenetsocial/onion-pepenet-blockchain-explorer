...
#
# This module defines
#     Pepenet_XXX_LIBRARIES, the libraries needed to use ethereum.
#     Pepenet_FOUND, If false, do not try to use ethereum.
#
...
foreach (l ${LIBS})
	...
	message(STATUS FindPepenet " Xmr_${L}_LIBRARIES ${Xmr_${L}_LIBRARY}")
...
if (EXISTS ${PEPENET_BUILD_DIR}/src/ringct/libringct_basic.a)
	message(STATUS FindPepenet " found libringct_basic.a")
	add_library(ringct_basic STATIC IMPORTED)
	set_property(TARGET ringct_basic
			PROPERTY IMPORTED_LOCATION ${PEPENET_BUILD_DIR}/src/ringct/libringct_basic.a)
endif()

if (EXISTS ${PEPENET_BUILD_DIR}/src/cryptonote_basic/libcryptonote_format_utils_basic.a)
        message(STATUS FindPepenet " found libcryptonote_format_utils_basic.a")
        add_library(cryptonote_format_utils_basic STATIC IMPORTED)
        set_property(TARGET cryptonote_format_utils_basic
                PROPERTY IMPORTED_LOCATION ${PEPENET_BUILD_DIR}/src/cryptonote_basic/libcryptonote_format_utils_basic.a)
endif()


message(STATUS ${PEPENET_SOURCE_DIR}/build)

# include pepenet headers
include_directories(
		${PEPENET_SOURCE_DIR}/src
                ${PEPENET_SOURCE_DIR}/src/crypto
                ${PEPENET_SOURCE_DIR}/src/crypto/wallet
		${PEPENET_SOURCE_DIR}/external
		${PEPENET_SOURCE_DIR}/external/randomx/src
		${PEPENET_SOURCE_DIR}/build
