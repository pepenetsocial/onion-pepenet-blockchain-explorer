...
/**
* Parse pepenet address in a string form into
...
/**
* Return string representation of pepenet address
*/
string
...
{
    // default path to pepenet folder
    // on linux this is /home/<username>/.bitpepenet
    string default_pepenet_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_pepenet_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_pepenet_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_pepenet_dir + string("/lmdb");
}
